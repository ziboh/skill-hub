    ...
    <div class="confirm-modal">
      ...
      <div class="confirm-body">
        <p class="confirm-desc">
          确定要删除选中的 <strong>{{ skills.length }}</strong> 个 Skill 吗？此操作不可撤销。
        </p>
        ...
        <div v-if="uniquePlatforms.length" class="distributed-section">
          <label class="remove-distributed-label">
            <input v-model="removeDistributed" type="checkbox" class="remove-distributed-checkbox" />
          ...
          <div v-if="removeDistributed" class="platform-select">
            <div class="platform-select-header">
              ...
              <button class="platform-select-all" @click="toggleAll">
                {{ allSelected ? '取消全选' : '全选' }}
              </button>
            </div>
